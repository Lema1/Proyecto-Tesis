...
function listaPDF1($tipo){
    $conBI = new ConexionBI();
    $sql = $conBI->prepare("CALL listar_reporte1(?)");
...
<body>
    ...
    <div class="panel panel-grey">
      ...
      <ul class="nav nav-pills">
          <li class="active"><a data-toggle="pill" href="#RepoChoque">Reporte de choques</a></li>
          <li><a data-toggle="pill" href="#Repomantencion">Reporte de mantenciones</a></li>
        ...
        <div id="RepoChoque" class="tab-pane fade in active">
            <div class="row-fluid">
            <!--FECHA-->
            <form action="PHP/Report/newReport.php" method="post">
                <h3><label for="inputFecha" class="control-label">Ingrese fecha   para el reporte</label></h3>
                <div style="width: 200px; display: inline-block; ">
                    <div class='input-icon right'>
                        <label for="" class="control-label">Desde:</label>
                        <i class="fa fa-calendar"></i>
                        <input type="date" name="inputFechaD" id="inputFechaD" class="form-control" /> 
                    </div>
                </div>
                <div style="width: 200px; display: inline-block;">
                    <div class='input-icon right'>
                        ...
                        <i class="fa fa-calendar"></i>
                        <input type="date" name="inputFechaH" id="inputFechaH" class="form-control" /> 
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach($listaReport1 as $lr1){ ?>
                        <tr>
                            <td><a href="Reportes/Rep1/<?php echo $lr1[1];?>(cr-<?php echo date('y-m-d',strtotime($lr1[2]));?>).pdf" target="_blank"><?php echo $lr1[1];?></a></td>
                            <td><?php echo $lr1[2];?></td>
                        </tr>
                        <?php }?>
                    </tbody>
                </table>
        ...
        <div id="Repomantencion" class="tab-pane fade">
            <div class="row-fluid">
