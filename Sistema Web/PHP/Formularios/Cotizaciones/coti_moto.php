            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOParDelCapo">Capo</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="MOimgPDC" class="file" name="MOimgPDC[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOParDeLMasc">Mascara</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgPDM" class="file" name="MOimgPDM[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOParDeLParaDel">Paracho delantero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgPDPD" class="file" name="MOimgPDPD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-md-6">
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        <td class="td-block">Parachoque</td>
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPTPara">Parachoque</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgPTP" class="file" name="MOimgPTP[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPTMaleta">Maletero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgPTM" class="file" name="MOimgPTM[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLDcostadoT">Costado Trasero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLDCT" class="file" name="MOimgLDCT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLDpuerta1">Puerta 1</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLDP1" class="file" name="MOimgLDP1[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLDpuerta2">Puerta 2</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLDP2" class="file" name="MOimgLDP2[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLDlateralD">Costado Delantero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLDCD" class="file" name="MOimgLDCD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-md-6">
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        <td class="td-block">Costado Delantero</td>
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLIcostadoD">Costado Delantero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLICD" class="file" name="MOimgLICD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td class="td-block">Puerta 1</td>
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLIpuerta1">Puerta 1</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLIP1" class="file" name="MOimgLIP1[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td class="td-block">Puerta 2</td>
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLIpuerta2">Puerta 2</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLIP2" class="file" name="MOimgLIP2[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block">Costado Trasero</td>
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPLIcostadoT">Costado Trasero</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgLICT" class="file" name="MOimgLICT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a data-toggle="modal" data-target="#MOPATecho">Techo</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="MOimgPAT" class="file" name="MOimgPAT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
