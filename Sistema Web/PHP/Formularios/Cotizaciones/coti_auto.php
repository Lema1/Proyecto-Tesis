...
<div class="row">
    <div class="col-lg-12">
        <label><h4>Daños de la Carroceria<input type="checkbox" name="carroceria" class="checkbox-inline" value="carroceria"></h4></label>
    </div>
</div>
<div id="carroceria">
    <div class='row'>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moParDelCapo">Detalle</a></td>
                        <div id="moParDelCapo" class="modal fade" role="dialog">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="imgPDC" class="file" name="imgPDC[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moParDeLMasc">Detalle</a></td>
                        <!-- MODAL PARTE DELANTERA MASCARA -->
                        <div id="moParDeLMasc" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="imgPDM" class="file" name="imgPDM[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moParDeLParaDel">Detalle</a></td>
                        <!-- MODAL PARTE DELANTERA PARACHOQUE DELANTERO -->
                        <div id="moParDeLParaDel" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgPDPD" class="file" name="imgPDPD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-md-6">
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        <td class="td-block">Parachoque</td>
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPTPara">Detalle</a></td>
                        <!-- MODAL PARTE TRASERA PARACHOQUE -->
                        <div id="moPTPara" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgPTP" class="file" name="imgPTP[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPTMaleta">Detalle</a></td>
                        <!-- MODAL PARTE TRASERA MALETERO -->
                        <div id="moPTMaleta" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgPTM" class="file" name="imgPTM[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLDcostadoT">Detalle</a></td>
                        <!-- MODAL LATERAL DERECHO COSTADO TRASERO -->
                        <div id="moPLDcostadoT" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLDCT" class="file" name="imgLDCT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLDpuerta1">Detalle</a></td>
                        <!-- MODAL LATERAL DERECHO PUERTA 1 -->
                        <div id="moPLDpuerta1" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLDP1" class="file" name="imgLDP1[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLDpuerta2">Detalle</a></td>
                        <!-- MODAL LATERAL DERECHO PUERTA 2 -->
                        <div id="moPLDpuerta2" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLDP2" class="file" name="imgLDP2[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLDlateralD">Detalle</a></td>
                        <!-- MODAL LATERAL DERECHO COSTADO DELANTERO -->
                        <div id="moPLDlateralD" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                              <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLDCD" class="file" name="imgLDCD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="col-md-6">
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        <td class="td-block">Costado Delantero</td>
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLIcostadoD">Detalle</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLICD" class="file" name="imgLICD[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td class="td-block">Puerta 1</td>
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLIpuerta1">Detalle</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLIP1" class="file" name="imgLIP1[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td class="td-block">Puerta 2</td>
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLIpuerta2">Detalle</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLIP2" class="file" name="imgLIP2[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <tr>
                        <td class="td-block">Costado Trasero</td>
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPLIcostadoT">Detalle</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgLICT" class="file" name="imgLICT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <table class="table table-responsive">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="td-block"><a class="btn btn-grey" data-toggle="modal" data-target="#moPATecho">Detalle</a></td>
                                        ...
                                        <div class="row">
                                            <div class="panel col-lg-12">
                                                <div class="form-group">
                                                    <label>Imagenes</label>
                                                    <label for="file">Test invalid input type</label>
                                                    <input id="imgPAT" class="file" name="imgPAT[]" type="file" multiple >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
