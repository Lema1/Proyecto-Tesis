...
<html lang="en">
<head>
    <title>Flujo de Trabajo | Flujo de Trabajo</title>
    <meta charset="utf-8">
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="FlujoProcesos.php"><i class="fa fa-th-list fa-fw">
                        <div class="icon-bg bg-blue"></div>
                ...
                <div class="page-content">
                    <div id="tab-general">
                        ...
                        <div class="row mbl">
                            ...
                            <div class="col-lg-12">
                <!-- empieza las tablas de procesos-->
                <div class="row">
                    <div class="col-lg-12">
                       <div id="lista_flujo"></div>
                    </div>
                </div>
